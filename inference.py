...
if __name__=='__main__':
    ...
    !cp -r './m3d-vton/input_data/image/person@1=person_whole_front.png' './2D-Human-Parsing/demo_imgs'
    !cd 2D-Human-Parsing
    ...
    !cd ..
    !cd ..
    !cp -r './2D-Human-Parsing/parsing_result/train_parsing/demo_imgs/person@1=person_whole_front_label.png' './m3d-vton/input_data/image-parse' 
    
    # creating pose keypoints
    !cp -r './m3d-vton/input_data/image/person@1=person_whole_front.png' './openpose/examples/media'
    !cd openpose
    ...
    !cd ..
    !cp -r './openpose/output_json_folder/person@1=person_whole_front_000000000000_keypoints.json' './m3d-vton/input_data/pose/person@1=person_whole_front_keypoints.json'
